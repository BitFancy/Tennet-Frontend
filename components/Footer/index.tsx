                  ...
                  <form action="#">
                    <div className="relative">
                      <input
                        ...
                        className="w-full rounded-md border border-stroke px-6 py-3 shadow-solid-11 focus:border-gray-800 focus:outline-none dark:border-strokedark dark:bg-black dark:shadow-none dark:focus:border-primary"
                      />
